...
import {
  BENCHMARK_WIDGET_REGISTRY,
  getBenchmarkWidgetsByCategory,
  type BenchmarkWidgetDefinition,
} from "@/lib/benchmarks/widget-registry";

type BenchmarkWidgetPickerProps = {
...
export function BenchmarkWidgetPicker({ activeWidgets, onToggleWidget }: BenchmarkWidgetPickerProps) {
  ...
  const allWidgets = Object.values(BENCHMARK_WIDGET_REGISTRY);
      ...
      {isOpen && (
        <div className="absolute right-0 top-full z-50 mt-2 w-80 rounded-2xl border border-border/50 bg-white shadow-xl">
          ...
          <div className="flex items-center justify-between border-b border-border/30 px-4 py-3">
            <h3 className="font-semibold text-brand-900">Benchmark Widgets</h3>
            <button
              type="button"
