...
import { BarChart3, Briefcase, Check, ChevronDown, Layout, RotateCcw, Target, Smartphone } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import { PRESET_LAYOUTS, type LayoutPreset } from "@/lib/dashboard/preset-layouts";
...
export function PresetSwitcher({
  ...
  const currentPreset = PRESET_LAYOUTS.find(p => p.id === currentPresetId);
