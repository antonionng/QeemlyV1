...
export function RecommendedRangeWidget({
  ...
  return (
    <div className="flex flex-col p-1">
      ...
      <div className="mt-5 rounded-2xl border border-border bg-accent-50 p-4">
        <div className="flex items-center justify-between text-[10px] font-semibold uppercase tracking-wider text-accent-500">
          <span>Min</span>
          <span>Target</span>
          <span>Max</span>
        </div>
        ...
        <div className="mt-2 flex items-center justify-between text-xs font-semibold text-brand-900">
