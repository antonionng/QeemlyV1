...
export const REPORT_TEMPLATES: ReportTemplate[] = [
  ...
  },
  {
    ...
    typeId: "compliance",
    title: "Pay Governance Review",
    description: "Track pay equity gaps, benchmark coverage, and remediation actions.",
    cadence: "Monthly",
  ...
  },
  {
    ...
    typeId: "compliance",
    title: "Workforce Compliance Controls",
    description: "Track policy completion, approvals, and control exceptions.",
    cadence: "On demand",
    coverage: "All offers",
    confidence: "Medium",
