...
export const EMPLOYEE_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    label: "Total Salary",
    required: false,
    aliases: ["total salary", "total comp", "total compensation", "ctc", "gross salary"],
    type: "number",
  },
  {
    key: "baseSalary",
    label: "Base Salary (Legacy)",
    required: false,
  ...
  },
  {
    ...
    required: false,
    aliases: ["transport allowance", "transport", "travel allowance", "mobility allowance"],
    type: "number",
  },
  {
    ...
    required: false,
    aliases: ["accommodation allowance", "housing allowance", "accommodation", "housing"],
    type: "number",
  },
  {
    key: "bonus",
  ...
  },
  {
    ...
    label: "Equity Units",
    required: false,
    aliases: ["equity units", "units", "stock units", "shares granted"],
    type: "number",
  },
  {
    key: "equityPercent",
    ...
    required: false,
    aliases: ["equity percent", "equity percentage", "ownership percent", "ownership %"],
    type: "number",
  },
  {
    key: "currency",
