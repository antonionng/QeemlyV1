...
const PROFESSION_KEYWORDS: Array<{ keywords: string[]; roleId: string }> = [
  ...
  { keywords: ["business", "operations", "analyst"], roleId: "biz-ops-analyst" },
  { keywords: ["business", "operations", "manager"], roleId: "biz-ops-manager" },
  { keywords: ["business", "ops"], roleId: "biz-ops-analyst" },
  { keywords: ["bizops"], roleId: "biz-ops-analyst" },
  { keywords: ["revenue", "operations"], roleId: "rev-ops-manager" },
  { keywords: ["revops"], roleId: "rev-ops-manager" },
  { keywords: ["sales", "operations"], roleId: "sales-ops-manager" },
  { keywords: ["sales", "ops"], roleId: "sales-ops-analyst" },
  { keywords: ["marketing", "operations"], roleId: "marketing-ops-manager" },
  { keywords: ["people", "operations"], roleId: "people-ops" },
  { keywords: ["customer", "operations", "analyst"], roleId: "customer-ops-analyst" },
  { keywords: ["customer", "operations", "manager"], roleId: "customer-ops-manager" },
  { keywords: ["customer", "ops"], roleId: "customer-ops-analyst" },
  { keywords: ["customer", "support"], roleId: "customer-support-rep" },
  { keywords: ["office", "manager"], roleId: "office-manager" },
  { keywords: ["executive", "assistant"], roleId: "executive-assistant" },
  { keywords: ["administrative", "assistant"], roleId: "admin-assistant" },
  { keywords: ["facilities", "manager"], roleId: "facilities-manager" },
  { keywords: ["supply", "chain"], roleId: "supply-chain-analyst" },
  { keywords: ["procurement"], roleId: "procurement-specialist" },
  { keywords: ["logistics"], roleId: "logistics-coordinator" },
  { keywords: ["payroll"], roleId: "payroll-specialist" },
  { keywords: ["talent", "sourcer"], roleId: "talent-sourcer" },
  { keywords: ["hris"], roleId: "hris-analyst" },
  { keywords: ["implementation", "specialist"], roleId: "implementation-specialist" },
  { keywords: ["onboarding", "specialist"], roleId: "onboarding-specialist" },
];
...
const ROLE_ALIASES: Record<string, string> = {
  ...
  "business operations analyst": "biz-ops-analyst",
  "business operations manager": "biz-ops-manager",
  "business ops analyst": "biz-ops-analyst",
  "business ops manager": "biz-ops-manager",
  "biz ops analyst": "biz-ops-analyst",
  "biz ops manager": "biz-ops-manager",
  "bizops analyst": "biz-ops-analyst",
  "revenue operations analyst": "rev-ops-analyst",
  "revenue operations manager": "rev-ops-manager",
  "revops analyst": "rev-ops-analyst",
  "revops manager": "rev-ops-manager",
  "sales operations analyst": "sales-ops-analyst",
  "sales operations manager": "sales-ops-manager",
  "sales ops analyst": "sales-ops-analyst",
  "sales ops manager": "sales-ops-manager",
  "marketing operations manager": "marketing-ops-manager",
  "marketing ops manager": "marketing-ops-manager",
  "people operations manager": "people-ops",
  "people operations analyst": "people-ops-analyst",
  "people ops analyst": "people-ops-analyst",
  "customer operations analyst": "customer-ops-analyst",
  "customer operations manager": "customer-ops-manager",
  "customer ops analyst": "customer-ops-analyst",
  "customer ops manager": "customer-ops-manager",
  "customer support representative": "customer-support-rep",
  "customer support specialist": "support-specialist",
